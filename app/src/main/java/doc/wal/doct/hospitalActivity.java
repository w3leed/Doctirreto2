...
import doc.wal.doct.models.doctorInfo;
...
public class hospitalActivity extends AppCompatActivity {
    ...
    private void showAboutUsDialog() {
        ...
        String text = "Doctirretto is a Complete app for Doctors and Patients. Developed by2MIT More Features Coming soon... <br><br>&emsp;<a href='https://github.com'> Github </a> &emsp;" +
                "  <a href='https://in.linkedin.com/in/bhavya-arora-716b37145'> Linkedin </a> &emsp;  <a href='http://wwww.google.com'> Website </a>" +
                "<br><br><strong>Privacy and Policy / Open Source Licenses:</strong> <a href=''> Check Here. </a><br><br><Strong>Fork us on Github: </Strong><a href='https://github.com/'>Here. </a><br><br> If any Issue/Bug contact us here: <a href=\"mailto:waleedkhadroui@gmail.com?Subject=Hello%20again\" target=\"_top\">here</a>";
        textView.setText(Html.fromHtml(text));


        mMaterialDialog = new MaterialDialog(this)
                .setTitle("Doctirretto")
                .setMessage("Doctirretto is a Complete App for Doctors and Patient. Developed by 2MIT.")
