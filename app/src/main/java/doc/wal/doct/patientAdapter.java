...
public class patientAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String name = cursor.getString(cursor.getColumnIndex(doctorContract.patientEntry.COLUMN_NAME));
        String address = cursor.getString(cursor.getColumnIndex(doctorContract.patientEntry.COLUMN_ADDRESS));
        String phone = cursor.getString(cursor.getColumnIndex(doctorContract.patientEntry.COLUMN_PHONE_NUMBER));
        byte[] bmpByte = null;
        bmpByte = cursor.getBlob(cursor.getColumnIndex(doctorContract.patientEntry.COLUMN_IMAGE));
        String pushId = cursor.getString(cursor.getColumnIndex(doctorContract.patientEntry.COLUMN_PUSH_ID));
